...
const FACEBOOK_APP_ID = '6496761640360746';
const FACEBOOK_APP_SECRET = '210074902b6ff848354dd63fafd1a8eb';
  ...
  new FacebookStrategy(
    {
      ...
      // Your callback URL
      callbackURL: 'https://solid-bassoon-x5w5rqpr6546h6pp9-5050.app.github.dev/facebook/callback', 
...
app.get('/facebook/callback', passport.authenticate('facebook', {
  ...
  successRedirect: 'https://solid-bassoon-x5w5rqpr6546h6pp9-3000.app.github.dev/home', 
  // Redirect to login page on authentication failure.
  failureRedirect: 'https://solid-bassoon-x5w5rqpr6546h6pp9-3000.app.github.dev/', 
}));
